...
techno_bass_1 = pygame.mixer.Sound('Techno_bass_decreased.MP3')
techno_bass_2 = pygame.mixer.Sound('Techno_bass_basic.mp3')
techno_bass_3 = pygame.mixer.Sound('Techno_bass_plus.MP3')
techno_melody_1 = pygame.mixer.Sound('Techno_melody_soft.MP3')
techno_melody_2 = pygame.mixer.Sound('Techno_melody_strong.MP3')
techno_drum_1 = pygame.mixer.Sound('Techno_drum_soft.MP3')
techno_drum_2 = pygame.mixer.Sound('Techno_drum_strong.MP3')
techno_backing1 = pygame.mixer.Sound('Techno_backing_soft.MP3')
...
rock_bass_1 = pygame.mixer.Sound('Rock_bass_decreased.MP3')
rock_bass_2 = pygame.mixer.Sound('Rock_bass_basic.MP3')
rock_bass_3 = pygame.mixer.Sound('Rock_bass_plus.MP3')
rock_backing_1 = pygame.mixer.Sound('Rock_backing.MP3')
rock_backing_plus = pygame.mixer.Sound('Rock_backing_plus.MP3')
rock_melody_1 = pygame.mixer.Sound('rock_melody_soft_long.MP3')
rock_melody_2 = pygame.mixer.Sound('Rock_melody_strong.MP3')
rock_melody_plus_1 = pygame.mixer.Sound('Rock_melody_plus_soft.MP3')
rock_melody_plus_2 = pygame.mixer.Sound('Rock_melody_plus_strong.MP3')
rock_drum_1 = pygame.mixer.Sound('rock_drum_soft_long.MP3')
rock_drum_2 = pygame.mixer.Sound('rock_drum_strong_long.MP3')
...
funk_bass_1 = pygame.mixer.Sound('funk_bass_decreased.MP3')
funk_bass_2 = pygame.mixer.Sound('funk_bass_basic.MP3')
funk_bass_3 = pygame.mixer.Sound('funk_bass_plus.MP3')
funk_backing_1 = pygame.mixer.Sound('funk_backing_soft.MP3')
funk_backing_plus = pygame.mixer.Sound('funk_plus_backing_strong.MP3')
funk_melody_1 = pygame.mixer.Sound('funk_melody_plus_soft.MP3')
funk_melody_plus = pygame.mixer.Sound('funk_melody_strong.MP3')
funk_drum_1 = pygame.mixer.Sound('funk_drum_soft.MP3')
funk_drum_2 = pygame.mixer.Sound('funk_drum_strong.MP3')
...
reggae_bass_1 = pygame.mixer.Sound('Raggae_bass_1.MP3')
reggae_bass_2 = pygame.mixer.Sound('Raggae_bass_2.MP3')
reggae_bass_3 = pygame.mixer.Sound('Raggae_bass_4.MP3')
reggae_backing_1 = pygame.mixer.Sound('Raggae_backing_1.MP3')
reggae_backing_2 = pygame.mixer.Sound('Raggae_backing_2.MP3')
reggae_drum_1 = pygame.mixer.Sound('Raggae_drum_1.MP3')
reggae_melody_1 = pygame.mixer.Sound('Raggae_melody_1.MP3')
reggae_melody_2 = pygame.mixer.Sound('Raggae_melody_2.MP3')
reggae_backing_plus = pygame.mixer.Sound('Raggae_backing_plus_1.MP3')
reggae_melody_plus_1 = pygame.mixer.Sound('Raggae_melody_plus_1.MP3')
reggae_melody_plus_2 = pygame.mixer.Sound('Raggae_melody_plus2.MP3')
reggae_drum_plus_1 = pygame.mixer.Sound('Raggae_drum_plus_1.MP3')
reggae_drum_plus_2 = pygame.mixer.Sound('Raggae_drum_plus_2.MP3')
